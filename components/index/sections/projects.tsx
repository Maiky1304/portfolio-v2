  ...
  return (
    <Section id="projects">
      <div className="text-center mx-auto">
        <h2 className="text-3xl text-primary font-bold overflow-hidden">
      ...
      <div className="flex mt-20 justify-center">
        <a
          href={
            socials.find((link) => link.includes("github")) ||
            "https://github.com/Maiky1304"
          }
          target="_blank"
          rel="noreferrer"
          aria-labelledby="button to github page"
          className="border border-dark-50 px-5 py-3 rounded-md hover:cursor-pointer"
        >
          View more
        </a>
      </div>
